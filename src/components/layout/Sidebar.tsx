...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  const { setSidebarOpen, setActiveModal, radioConnected, activeView, setActiveView } = useAppStore();
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 14.142M5 7h4l5-5v20l-5-5H5a2 2 0 01-2-2V9a2 2 0 012-2z" />
        </svg>
      ),
      disabled: !radioConnected,
    },
